  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg text-text">Lastest Transaction</h2>
      ...
      <div className="space-y-4">
        {transactions.map((item, index) => (
          ...
          >
            ...
            {/* Email */}
            <p className="text-sm text-text-secondary w-[180px]">{item.email}</p>
